  ...
  return (
                ...
                <div className="col-lg-12">
                    <div className="breadcrumb-area-inner">
                        ...
                        <div className="nav-area-navigation">
                            <Link href="/">home</Link>
                            <Link className="current" href="/commercial_service">Service Details</Link>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div className="service-details-area rts-section-gapTop pb--60">
        <div className='container'> <div className="service-details-inner-area-wrapper">  <div className="service-details-inner-area-wrapper">
                <h4 className="title">Commercial Construction Service Categories</h4>
                <div className="service-main-wrapper-tabs">
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="nav-link active" id="concrete-repair-tab" data-bs-toggle="tab" data-bs-target="#concrete-repair" type="button" role="tab" aria-controls="concrete-repair" aria-selected="true">Commercial Concrete Repair</button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button className="nav-link" id="foundation-recovery-tab" data-bs-toggle="tab" data-bs-target="#foundation-recovery" type="button" role="tab" aria-controls="foundation-recovery" aria-selected="false">Commercial Foundation Recovery</button>
                    </li>
                    
                    <li className="nav-item" role="presentation">
                      <button className="nav-link" id="waterproofing-tab" data-bs-toggle="tab" data-bs-target="#waterproofing" type="button" role="tab" aria-controls="waterproofing" aria-selected="false">Commercial Waterproofing</button>
                    </li>
                  </ul>
